...
var file_HelloWorld_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x09, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x2e, 0x70, 0x62, 0x22, 0x22, 0x0a,
	...
	0x12, 0x17, 0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x2e, 0x70, 0x62, 0x2e, 0x48, 0x65, 0x6c,
	0x6c, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x15, 0x2e, 0x6d, 0x6f, 0x64, 0x65,
	0x6c, 0x73, 0x2e, 0x70, 0x62, 0x2e, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79,
...
var file_HelloWorld_proto_goTypes = []interface{}{
	(*HelloRequest)(nil), // 0: models.pb.HelloRequest
	(*HelloReply)(nil),   // 1: models.pb.HelloReply
}
var file_HelloWorld_proto_depIdxs = []int32{
	0, // 0: models.pb.Greeter.SayHello:input_type -> models.pb.HelloRequest
	1, // 1: models.pb.Greeter.SayHello:output_type -> models.pb.HelloReply
...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/models.pb.Greeter/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/models.pb.Greeter/SayHello",
	}
